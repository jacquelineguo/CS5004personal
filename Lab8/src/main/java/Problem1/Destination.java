...
public class Destination {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(getDestinationName(), that.getDestinationName())
        && Objects.equals(getCountry(), that.getCountry()) && Objects
        .equals(getAirportCode(), that.getAirportCode()) && Objects
        .equals(getDistanceFromSeattle(), that.getDistanceFromSeattle());
  }

  @Override
  public int hashCode() {
    return Objects
        .hash(getDestinationName(), getCountry(), getAirportCode(), getDistanceFromSeattle());
  }
