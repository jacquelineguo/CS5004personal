...
public class CommandLineParserTest {
    ...
    public void testMissingCsvException() throws InvalidArgumentsException {
        String[] c4 = {"--add-todo --todo-text todo1 --completed --date 7/21/2050 --priority 3 -- category work --complete-todo 2 --display"};
        CommandLineParser cml4 = new CommandLineParser(c4);
    }

    @Test (expected = InvalidArgumentsException.class)
    public void testMissingTodoTextException() throws InvalidArgumentsException {
        String[] c5 = {"--csv-file todos.csv --add-todo --completed --date 7/21/2050 --priority 3 -- category work --complete-todo 2 --display"};
        CommandLineParser cml5 = new CommandLineParser(c5);
    }

    @Test (expected = InvalidArgumentsException.class)
    public void testInvalidPriorityException() throws InvalidArgumentsException {
        String[] c6 = {"--csv-file todos.csv --add-todo --todo-text todo1 --completed --date 7/21/2050 --priority 4 -- category work --complete-todo 2 --display"};
        CommandLineParser cml6 = new CommandLineParser(c6);
    }

    @Test (expected = InvalidArgumentsException.class)
    public void testMultipleSortException() throws InvalidArgumentsException {
        String[] c7 = {"--add-todo --todo-text todo1 --completed --date 7/21/2050 --priority 3 -- category work --complete-todo 2 --display --sort-by-date --sort-by-priority"};
